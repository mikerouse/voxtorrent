        ...
        <div class="w-full max-w-3xl bg-white dark:bg-gray-800 rounded shadow-md py-6">
            <div class="px-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">
                    <span class="text-red-500 dark:text-red-500">Edit</span> an issue
                </h1>
            ...
            <div class="px-4">
                ...
                <div class="mt-4">
                    <div id="torrent_name_container" class="mb-4">
                        ...
                        <input id="torrentName" name="torrentName" value="{{ $torrent->name }}" wire:model="torrentName" placeholder="sum it up in a sentence"
